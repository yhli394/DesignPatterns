...
/**
 * @author yhli3
 * @ClassName QuestionBankController.java
 * @packageName yhli.work.designpatternsdemo.prototypepattern.p1
 * @createTime 2022年12月08日 15:20:00
 */
public class QuestionBankController {

    private QuestionBank questionBank = new QuestionBank();

    public QuestionBankController() throws CloneNotSupportedException {

        //QuestionBank bank1 = (QuestionBank) questionBank.clone();
        //System.out.println(bank1==questionBank);
        //System.out.println(questionBank.choiceQuestionList==bank1.choiceQuestionList);
